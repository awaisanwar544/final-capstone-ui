...
function NavigationBar() {
  const inactiveClassName = 'flex flex-col bg-custom-white-500 text-custom-grey-500 text-xl font-extrabold h-20 justify-center p-5 hover:text-custom-white-500 hover:bg-custom-green-500';
